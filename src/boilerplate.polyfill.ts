...
//         DriverUtils.buildAlias(driver, { joiner: alias.name }, column.databaseName)
//       )
//     )
//   } else {
//     keys.push(
...
//     DriverUtils.buildAlias(this.connection.driver, { joiner: alias.name }, column.databaseName)
//   )
